    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.infos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('need') ? 'is-invalid' : '' }}" type="text" name="need" id="need" value="{{ old('need', '') }}">
                @if($errors->has('need'))
                    <div class="invalid-feedback">
                        {{ $errors->first('need') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('redirecturl') ? 'is-invalid' : '' }}" type="text" name="redirecturl" id="redirecturl" value="{{ old('redirecturl', '') }}">
