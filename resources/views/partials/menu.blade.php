<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('registerd_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.registerds.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/registerds") || request()->is("admin/registerds/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.registerd.title') }}
                </a>
            </li>
        @endcan
